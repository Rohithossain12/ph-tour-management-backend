...
router.get("/invoice/:paymentId", (0, check_auth_1.checkAuth)(...Object.values(user_interface_1.Role)), payment_controller_1.PaymentController.getInvoiceDownloadUrl);
