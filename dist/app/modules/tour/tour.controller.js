...
const updateTour = (0, catchAsync_1.catchAsync)(async (req, res) => {
    const payload = Object.assign(Object.assign({}, req.body), { images: req.files.map(file => file.path) });
    const result = await tour_service_1.TourService.updateTour(req.params.id, payload);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
...
const deleteTour = (0, catchAsync_1.catchAsync)(async (req, res) => {
    const { id } = req.params;
    const result = await tour_service_1.TourService.deleteTour(id);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
...
const getSingleTourType = (0, catchAsync_1.catchAsync)(async (req, res) => {
    const id = req.params.id;
    const result = await tour_service_1.TourService.getSingleTourType(id);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
...
const getAllTourTypes = (0, catchAsync_1.catchAsync)(async (req, res) => {
    const query = req.query;
    const result = await tour_service_1.TourService.getAllTourTypes(query);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
...
const updateTourType = (0, catchAsync_1.catchAsync)(async (req, res) => {
    const { id } = req.params;
    const { name } = req.body;
    const result = await tour_service_1.TourService.updateTourType(id, name);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
...
const deleteTourType = (0, catchAsync_1.catchAsync)(async (req, res) => {
    const { id } = req.params;
    const result = await tour_service_1.TourService.deleteTourType(id);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
